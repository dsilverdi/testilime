...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "testilime.context_processors.google_oauth_client_id",
                "testilime.context_processors.stripe_publishable_key",
            ],
        },
    },
]

WSGI_APPLICATION = "testilime.wsgi.application"
...
AUTH_USER_MODEL = "testilime_auth.User"
